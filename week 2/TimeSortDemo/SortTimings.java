...
public class SortTimings {
	...
	public void timer(int start, int stop, int increment, int trials) {
		for(int k=start; k <= stop; k += increment) {
			...
			//1e9 is scientific notation it stands for 1 followed by 9 zeros or 1000000000
			...
			//print formating below is printing double = k, tab 
			//float that includes 3 numbers with two on the decimal side = stime, tab
			//float that includes 3 numbers with two on the decimal side = ttime, new line
